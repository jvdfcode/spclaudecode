      ...
      <main className="mx-auto max-w-3xl px-6 py-10 md:py-16">
        ...
        <section className="mt-12 grid gap-4 md:grid-cols-3 text-center">
          <div className="rounded-2xl border border-paper-200 bg-white p-5">
            <p className="text-2xl font-extrabold text-ink-950">100%</p>
            <p className="mt-1 text-xs text-ink-700">grátis e sem cadastro</p>
          </div>
          <div className="rounded-2xl border border-paper-200 bg-white p-5">
            <p className="text-2xl font-extrabold text-ink-950">30s</p>
            <p className="mt-1 text-xs text-ink-700">para descobrir sua margem real</p>
          </div>
          <div className="rounded-2xl border border-paper-200 bg-white p-5">
            <p className="text-2xl font-extrabold text-ink-950">+R$ 0,00</p>
            <p className="mt-1 text-xs text-ink-700">é o que você está deixando na mesa hoje</p>
          </div>
        </section>
      </main>

      <footer className="mt-12 border-t border-paper-200 bg-white py-6">
        <div className="mx-auto max-w-5xl px-6 text-center text-xs text-ink-500">
          SmartPreço · v1.0 ·{' '}
          <a href="/login" className="underline hover:text-ink-950">
